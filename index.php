	...
	<div id="container">
		<div id="header">
			...
			<div id="nama-alamat-perpustakaan-container">
				...
				<div class="nama-alamat-perpustakaan">
					<h4>Jl. Mutchar Raya No 23, Telp: (021)34567344</h4>
				</div>
			</div>
		</div>
		<div id="header2">
		...
		<div id="sidebar">
			...
			<ul>
				<li><a href="index.php?p=listanggota">Data Anggota</a></li>
				<li><a href="index.php?p=buku">Data Buku</a></li>
			</ul>
			<p class="label-navigasi">Data Transaksi</p>
			<ul>
				<li><a href="index.php?p=listborrow">Transaksi Peminjaman</a></li>
